...
def read_medical_record(record_id: str):
    return medical_collection.find_one({"_id": record_id})

def update_medical_record(record_id: str, medical_data: dict):
    return medical_collection.update_one({"_id": record_id}, {"$set": medical_data})

def delete_medical_record(record_id: str):
    return medical_collection.delete_one({"_id": record_id})
...
def read_achievement(achievement_id: str):
    return achievement_collection.find_one({"_id": achievement_id})

def update_achievement(achievement_id: str, achievement_data: dict):
    return achievement_collection.update_one({"_id": achievement_id}, {"$set": achievement_data})

def delete_achievement(achievement_id: str):
    return achievement_collection.delete_one({"_id": achievement_id})