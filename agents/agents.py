...
def get_data(boot):
    ...
    prompt = [
        "You are a data collector who collects data by generating questions. Generate the questions in single line and use user friendly language. For Example if the points are 'AGE'->int, 'STROKE'->'Yes or No'"
        "Give the question like '1. What is your age?[AGE] 2. Have you ever had a stroke.[STROKE]'",
        "You are a question validator who checks whether the question is related to the diagnosis of patient. If yes then return the questions related to medical or health like a doctor ask to his patient."
